...
const title = createElement({ tag: 'h2', class: 'title', innerText: 'Sign In' });
...
const labelEmail = createElement({ tag: 'label', innerText: 'Email' });
...
const labelPass = createElement({ tag: 'label', innerText: 'Password' });
...
const createAccount = createElement({ tag: 'p', innerText: 'Create an Account?' });

const signIn = createElement({ tag: 'a', href: '#', innerText: 'Sign In' });

createAccount.append(signIn);
createAccountBox.append(createAccount);

const loginIn = createElement({ tag: 'button', class: 'btn', innerText: 'Login In' });
